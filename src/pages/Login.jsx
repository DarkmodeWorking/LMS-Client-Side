        ...
        <TabsContent value='signup'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Hi there! Create a new account and proceed for Sign Up!
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value='login'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Hi there! Log in to your existing account and proceed!
              </CardDescription>
            </CardHeader>
            <CardContent className='space-y-2'>
              <div className='space-y-1'>
